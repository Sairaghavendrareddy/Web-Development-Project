      ...
      $.ajax({
        ...
        success: function(data) {
           ...
           if(data==0){
                ...
                $('#delivery_address_selection_modal').modal('hide');
                $('#add_delivery_save_address').html('<div class="address_default_address_left"><label class="address_page_radio"><input type="radio" name="default_address" id="default_address" checked><span><div class="address_page_radio_defaultaddress"><h3 class="address_page_defaultaddress_holder">'+name+'</h3><div class="address_page_defaultaddress_content">Block No:<span id="delivery_add_blockno">'+block_id+'</span>,Flot No:<span id="delivery_add_floatno">'+flat_id+'</span>,'+apartment_name+', '+apartment_address+' - '+apartment_pincode+'</div><div class="address_page_defaultaddress_content">Mobile - <span class="font_bold">'+phone+'</span></div></div></span></label></div>');
    ...
    $.ajax({
           ...
           success: function(response) {
              ...
              $(".selectpicker_"+prod_id1).val(prod_mes_id1).selectpicker("refresh");
               ...
               if (chk_prod_exits!= ''){
                 $(".1_addtocart_" + prod_id1).html('<div class="prodct-add-plsmin"><div class="prodct-plsmin " id="input_div"><input type="button" value="-" id="moins" onclick="minus(1,' +prod_id1 + ',' + prod_mes_id1 +')"><input class="plsmin-vlue chck_qty_' +prod_mes_id + '" type="text" size="25" value=' + prod_mes_id_qty +' readonly /><input type="button" value="+" id="plus" onclick="plus(' +prod_mes_id + ')"></div></div>');
   ...
   function addtocart(idtype,prod_id,prod_mes_id) {
       ...
       $.ajax({
           ...
           success: function(data){
               ...
               $(".1_addtocart_" + prod_id).html('<div class="prodct-add-plsmin"><div class="prodct-plsmin" id="input_div"><button type="button" id="moins" onclick="minus(' +idtype + ',' +
                   prod_id + ',' + prod_mes_id +')"><i class="fas fa-minus"></i></button><input class="plsmin-vlue chck_qty_' + prod_mes_id +'" type="text" size="25" value="1" readonly/><button type="button" id="plus" onclick="plus(' +prod_mes_id + ')"><i class="fas fa-plus"></i></button></div></div>');
               $(".2_addtocart_" + prod_id).html('<div class="prodct-add-plsmin"><div class="prodct-plsmin" id="input_div"><button type="button" id="moins" onclick="minus(' +idtype + ',' +
                   prod_id + ',' + prod_mes_id +')"><i class="fas fa-minus"></i></button><input class="plsmin-vlue chck_qty_' + prod_mes_id +'" type="text" size="25" value="1" readonly/><button type="button" id="plus" onclick="plus(' +prod_mes_id + ')"><i class="fas fa-plus"></i></button></div></div>');
               $(".3_addtocart_" + prod_id).html('<div class="prodct-add-plsmin"><div class="prodct-plsmin" id="input_div"><button type="button" id="moins" onclick="minus(' +idtype + ',' +
                   prod_id + ',' + prod_mes_id +')"><i class="fas fa-minus"></i></button><input class="plsmin-vlue chck_qty_' + prod_mes_id +'" type="text" size="25" value="1" readonly/><button type="button" id="plus" onclick="plus(' +prod_mes_id + ')"><i class="fas fa-plus"></i></button></div></div>');
                $(".4_addtocart_" + prod_id).html('<div class="prodct-add-plsmin"><div class="prodct-plsmin" id="input_div"><button type="button" id="moins" onclick="minus(' +idtype + ',' +
                   prod_id + ',' + prod_mes_id +')"><i class="fas fa-minus"></i></button><input class="plsmin-vlue chck_qty_' + prod_mes_id +'" type="text" size="25" value="1" readonly/><button type="button" id="plus" onclick="plus(' +prod_mes_id + ')"><i class="fas fa-plus"></i></button></div></div>');
                $(".5_addtocart_" + prod_id).html('<div class="prodct-add-plsmin"><div class="prodct-plsmin" id="input_div"><button type="button" id="moins" onclick="minus(' +idtype + ',' +prod_id + ',' + prod_mes_id +')"><i class="fas fa-minus"></i></button><input class="plsmin-vlue chck_qty_' + prod_mes_id +'" type="text" size="25" value="1" readonly/><button type="button" id="plus" onclick="plus(' +prod_mes_id + ')"><i class="fas fa-plus"></i></button></div></div>');
