   ...
   <div class="container-fluid">
      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18">Add Delivery Slots</h4>
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                   <form method="post" action="<?php echo base_url(); ?>admin/save_delivery_slots" id="save_delivery_slots1" name="save_delivery_slots" enctype="multipart/form-data" class="custom-validation" onsubmit="return validate()">
                    <div class="form-group row">
                          <label for="example-time-input" class="col-sm-2 col-form-label">Slot From</label>
                          <div class="col-sm-10">
                              <div class="input-group">
                                  <input type="text" name="slot_from" class="form-control" placeholder="Select Hours" id="slot_from" required />
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                              <div class="input-group">
                                  <input type="text" name="slot_to" class="form-control" placeholder="Select Mintus" id="slot_to" required />
                                  <div class="input-group-append">
                                      <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                  </div>
                              </div>
