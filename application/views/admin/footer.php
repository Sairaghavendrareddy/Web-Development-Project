<footer class="footer">
   <div class="container-fluid">
      <div class="row">
         <div class="col-12">
            © <script>document.write(new Date().getFullYear())</script> THE SOIL SON<span class="d-none d-sm-inline-block"> - Crafted with <i class="mdi mdi-heart text-danger"></i> by Raghavendra</span>
         </div>
      </div>
   </div>
</footer>
...
<div class="right-bar">
   <div data-simplebar class="h-100">
      ...
      <div class="p-4">
         <div class="mb-2">
            <img src="<?php echo base_url(); ?>assets/admin/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="">
         </div>
         ...
         <div class="mb-2">
            <img src="<?php echo base_url(); ?>assets/admin/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="">
         </div>
         <div class="custom-control custom-switch mb-3">
            <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsStyle="<?php echo base_url(); ?>assets/admin/css/bootstrap-dark.min.css" 
               data-appStyle="<?php echo base_url(); ?>assets/admin/css/app-dark.min.css" />
            <label class="custom-control-label" for="dark-mode-switch">Dark Mode</label>
         </div>
         <div class="mb-2">
            <img src="<?php echo base_url(); ?>assets/admin/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="">
         </div>
         <div class="custom-control custom-switch mb-5">
            <input type="checkbox" class="custom-control-input theme-choice" id="rtl-mode-switch" data-appStyle="<?php echo base_url(); ?>assets/admin/css/app-rtl.min.css" />
...
<!-- Sweet alert init js-->
<!-- <script src="<?php echo base_url(); ?>assets/admin/js/pages/sweet-alerts.init.js"></script> -->
