      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18">Combos</h4>
         ...
         <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
               <div class="dropdown">
                  <a class="btn btn-primary dropdown-toggle waves-effect waves-light" href="<?php echo base_url(); ?>admin/add_combo/" >
                  <i class="mdi mdi-plus mr-2"></i> Add Combos
                  </a>
               </div>
            </div>
         </div>
...
function All_Products_Data(sno){
    $('#prod_tb').DataTable({
        ...
        "serverSide": true,
        "ajax": {
        "url":  "<?php echo base_url();?>admin/get_combos",
        "data": function (d) {
            d.ispopsubtype = sno;
        }
        } 
...
function Get_mess(prod_id){
   ...
   $.ajax({
      type:"POST",
      dataType:"json",
      url: "<?php echo base_url();?>admin/combo_product",
