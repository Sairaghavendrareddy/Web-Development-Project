   ...
   <div class="container-fluid">
      ...
      <div class="row align-items-center">
         <div class="col-sm-6">
            <div class="page-title-box">
               <h4 class="font-size-18">Add Subscription Cancell Reason</h4>
               <ol class="breadcrumb mb-0">
                 <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/dashboard">Dashboard</a></li>
                  <li class="breadcrumb-item active">Add Subscription Cancell Reason</li>
               </ol>
            </div>
         </div>
         <div class="col-sm-6">
      ...
      <div class="row">
         <div class="col-lg-12">
            <div class="card">
               <div class="card-body">
                   <form method="post" action="<?php echo base_url(); ?>admin/save_subscription_cancell_reason" id="save_subscription_cancell_reason" name="save_subscription_cancell_reason" enctype="multipart/form-data" class="custom-validation">
