               ...
               <div class="card-body">
                  <form method="post" action="<?php echo base_url(); ?>admin/update_password" id="change_password" name="change_password" enctype="multipart/form-data" class="custom-validation">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                           <input type="text" name="old_password" id="old_password" class="form-control" required placeholder="Enter Old Password"/>
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label">New Password</label>
                        <div class="col-sm-10">
                           <input type="text" name="new_password" id="new_password" class="form-control" required placeholder="Enter New Password" data-parsley-minlength="6" />
                        </div>
                     </div>
                     <div class="form-group row">
                        <label for="example-time-input" class="col-sm-2 col-form-label">Confirm Password</label>
                        <div class="col-sm-10">
                           <input type="text" name="confirm_password" id="confirm_password" class="form-control" required data-parsley-minlength="6" placeholder="Enter Confirm Password"/>
                        </div>
                     </div>
